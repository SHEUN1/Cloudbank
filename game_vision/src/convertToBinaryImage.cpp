...
/**
	 ...
	 ****************************************************************************************/
 Mat  convertToBinaryImage::Watershed(Mat Binary, Mat origanal_image)
{
...
/**
	 ...
	 *  @return     Mat Binary image
	 ****************************************************************************************/
Mat convertToBinaryImage::binary_Inverse (Mat img,Mat origanal)
{
...
/**
	 ...
	 *  @return     Binary image
	 ****************************************************************************************/
Mat convertToBinaryImage::cleanupBinary(Mat Binary)
{
