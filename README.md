...
6. xdotool
7. Tensoflow (or any machine learning library you want to use to make use the data. This is not needed for the vision processing half)   
8. a cuda enabled GPU 
